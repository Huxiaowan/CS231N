...
root_path = '/home/huxiaowan/Documents/computer_vision/CS231/homework/The Third time/assignment3/cs231n'
sys.path.append(root_path)
import py_compile
py_compile.compile(root_path+"/layers.py")
...
sys.path.append(root_path)
import py_compile
py_compile.compile(root_path+"/rnn_layers.py")
